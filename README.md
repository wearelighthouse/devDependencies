...
[`npm`](https://www.npmjs.com/) is the package manager for JavaScript and pretty much any frontend `devDependecies` we need. We use it to install and manage all of our projects' frontend `devDependecies`.
